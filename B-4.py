...
def main():
    ...
    fukuoka_total_temp = sum(data["temperature"] for data in weather_information if data["prefecture"] == "福岡県")
    fukuoka_area_num = len([data for data in weather_information if data["prefecture"] == "福岡県"])
